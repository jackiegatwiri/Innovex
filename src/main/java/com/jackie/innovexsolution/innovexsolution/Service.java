...
public class Service {
    ...
    void processUserData(UserData userData) {
        ...
        while (month <= Integer.valueOf(userData.getMonths())) {
            ...
            int range = Integer.parseInt(userData.getHighestLimit()) - Integer.parseInt(userData.getLowerLimit()) + 1;
            ...
            Compute compute = new Compute(month, String.valueOf(initial), String.valueOf(generated), String.valueOf(initalGenerated), String.valueOf(total - initial), String.valueOf(total));
